...
BARRY_TEST_CASE("NetworkDense counts work", "[counts-dense]") {
  ...
  NetworkDense net(20, 20, source, target);
  ...
  NetStatsCounter<NetworkDense> counter(&net); 
  ...
  counter_density<NetworkDense>(counter.get_counters());
  counter_idegree15<NetworkDense>(counter.get_counters());
  counter_odegree15<NetworkDense>(counter.get_counters());
  counter_nodematch<NetworkDense>(counter.get_counters(), 0u);
  counter_nodeicov<NetworkDense>(counter.get_counters(), 0u);
  counter_nodeocov<NetworkDense>(counter.get_counters(), 0u);
  counter_nodecov<NetworkDense>(counter.get_counters(), 0u);
  counter_absdiff<NetworkDense>(counter.get_counters(), 1u, 1.0);
  counter_diff<NetworkDense>(counter.get_counters(), 1u, 1.0);
  counter_diff<NetworkDense>(counter.get_counters(), 1u, 2.0);
  counter_diff<NetworkDense>(counter.get_counters(), 1u, 3.0);
  counter_idegree<NetworkDense>(counter.get_counters(), {1u,2u,3u,4u});
  counter_odegree<NetworkDense>(counter.get_counters(), {1u,2u,3u,4u});
  std::cout << "done." << std::endl;
